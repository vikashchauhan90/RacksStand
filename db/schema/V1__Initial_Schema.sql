...
-- 2. Tables with foreign keys (create in order)
...
-- 4. Tables referencing previously created tables
...
-- Indexes
-- =====================================================
CREATE UNIQUE INDEX IF NOT EXISTS ix_m2m_clients_client_id ON m2m_clients (client_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_tenant_memberships_tenant_id_user_id_deleted_at ON tenant_memberships (tenant_id, user_id, deleted_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_tenant_subscriptions_tenant_id_product_id_deleted_at ON tenant_subscriptions (tenant_id, product_id, deleted_at);
...
-- =====================================================
-- Insert EF Core Migration Record
-- =====================================================
INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
